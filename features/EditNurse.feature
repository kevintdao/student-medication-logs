Feature:
  ...
  Scenario: Change my first name in the account as an nurse
  ...
  Scenario: Change my last name in the account as an nurse
    Given I am logged in as an "nurse"
    Given I am on the edit users page
  ...
  Scenario: Change my email in the account as an nurse
    Given I am logged in as an "nurse"
    Given I am on the edit users page
    Then I should see my "Email Address" in the input box
    When I change my "Email Address" to "newnurse@gmail.com"
    Then I should see "newnurse@gmail.com" as my "Email Address" on the page

  Scenario: Enable email notifications as an nurse
    Given I am logged in as an "nurse"
    Given I am on the edit users page
  ...
  Scenario: Enable text notifications as an nurse
    Given I am logged in as an "nurse"
    Given I am on the edit users page
  ...
  Scenario: Change my phone number as an nurse
    Given I am logged in as an "nurse"
    Given I am on the edit users page
